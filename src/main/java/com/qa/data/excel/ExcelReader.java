...
public class ExcelReader {// This will read the data from excel file and store that in a list data structure
							// for this i have used apache poi api
	public String path;
